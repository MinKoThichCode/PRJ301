...
public class ProjectsDTO {
    ...
    private int estimatedLaunch;

    public ProjectsDTO() {
    }

    public ProjectsDTO(int projectsID, String projectsName, String description, String status, int estimatedLaunch) {
    ...
    public int getEstimatedLaunch() {
        return estimatedLaunch;
    }

    public void setEstimatedLaunch(int estimatedLaunch) {
        this.estimatedLaunch = estimatedLaunch;
    }
